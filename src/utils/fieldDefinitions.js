...
export const fieldDefinitions = {
  ...
  originalModeledExcessProduction: {
    $schema: jsonSchemaStandard,
    title: 'Original Modeled Excess Production',
    description: 'Excess production calculated from the battery prediction model.',
    type: 'float',
    units: 'kWh',
  },
  newAppliancesExcessProduction: {
    $schema: jsonSchemaStandard,
    title: 'Excess Production Reduction From New Appliances',
    description: 'Excess production after adding new appliances to the grid',
    type: 'float',
    units: 'kWh',
  },
  ...
  originalModeledUnmetLoad: {
    $schema: jsonSchemaStandard,
    title: 'Original Modeled Unmet Load',
    description: 'Unmet load calculated from the battery prediction model.',
    type: 'float',
    units: 'kWh',
  },
  newAppliancesUnmetLoad: {
    $schema: jsonSchemaStandard,
    title: 'Unmet Load Due to New Appliances',
    description: 'Unmet load from the original HOMER.',
    type: 'float',
    units: 'kWh',
  },
  totalUnmetLoad: {
    ...
    description:
      'Unmet load, which includes the original HOMER unmet loads and additional unmet loads due to new appliances and ancillary equipment.',
    type: 'float',
    units: 'kWh',
  },
  ...
  hourOfDay: {
    $schema: jsonSchemaStandard,
    title: 'Hour of Day',
    description: 'The hour of the day, from 0 (midnight) to 23 (11pm)',
    type: 'integer',
  },
  dayOfWeek: {
    $schema: jsonSchemaStandard,
    title: 'Day of the Week',
    description: 'The number of the day of the week, from 0 (Monday) to 6 (Sunday)',
    type: 'integer',
  },
  month: {
    $schema: jsonSchemaStandard,
