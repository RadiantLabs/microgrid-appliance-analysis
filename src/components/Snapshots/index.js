    ...
    <Grid padded>
      ...
      <Header as="h2" image>
        <Header.Content>
          ...
          <Header.Subheader>
            If your current state is important, save a snapshot before reverting to an older
            snapshot.
          </Header.Subheader>
        </Header.Content>
      </Header>
